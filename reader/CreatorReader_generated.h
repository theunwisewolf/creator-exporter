...
template<> struct AnyNodeTraits<Prefab> {
...
template<> inline const Scene *NodeTree::object_as<Scene>() const {
  return object_as_Scene();
}

template<> inline const Sprite *NodeTree::object_as<Sprite>() const {
  return object_as_Sprite();
}

template<> inline const Label *NodeTree::object_as<Label>() const {
  return object_as_Label();
}

template<> inline const Particle *NodeTree::object_as<Particle>() const {
  return object_as_Particle();
}

template<> inline const TileMap *NodeTree::object_as<TileMap>() const {
  return object_as_TileMap();
}

template<> inline const Node *NodeTree::object_as<Node>() const {
  return object_as_Node();
}

template<> inline const Button *NodeTree::object_as<Button>() const {
  return object_as_Button();
}

template<> inline const ProgressBar *NodeTree::object_as<ProgressBar>() const {
  return object_as_ProgressBar();
}

template<> inline const ScrollView *NodeTree::object_as<ScrollView>() const {
  return object_as_ScrollView();
}

template<> inline const CreatorScene *NodeTree::object_as<CreatorScene>() const {
  return object_as_CreatorScene();
}

template<> inline const EditBox *NodeTree::object_as<EditBox>() const {
  return object_as_EditBox();
}

template<> inline const RichText *NodeTree::object_as<RichText>() const {
  return object_as_RichText();
}

template<> inline const SpineSkeleton *NodeTree::object_as<SpineSkeleton>() const {
  return object_as_SpineSkeleton();
}

template<> inline const VideoPlayer *NodeTree::object_as<VideoPlayer>() const {
  return object_as_VideoPlayer();
}

template<> inline const WebView *NodeTree::object_as<WebView>() const {
  return object_as_WebView();
}

template<> inline const Slider *NodeTree::object_as<Slider>() const {
  return object_as_Slider();
}

template<> inline const Toggle *NodeTree::object_as<Toggle>() const {
  return object_as_Toggle();
}

template<> inline const ToggleGroup *NodeTree::object_as<ToggleGroup>() const {
  return object_as_ToggleGroup();
}

template<> inline const PageView *NodeTree::object_as<PageView>() const {
  return object_as_PageView();
}

template<> inline const Mask *NodeTree::object_as<Mask>() const {
  return object_as_Mask();
}

template<> inline const DragonBones *NodeTree::object_as<DragonBones>() const {
  return object_as_DragonBones();
}

template<> inline const MotionStreak *NodeTree::object_as<MotionStreak>() const {
  return object_as_MotionStreak();
}

template<> inline const Prefab *NodeTree::object_as<Prefab>() const {
  return object_as_Prefab();
}

template<> inline const Layout *NodeTree::object_as<Layout>() const {
...
struct RichText FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool useSystemFont() const {
    return GetField<uint8_t>(VT_USESYSTEMFONT, 0) != 0;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_NODE) &&
           ...
           VerifyField<uint8_t>(verifier, VT_USESYSTEMFONT) &&
           verifier.EndTable();
  }
};
...
struct RichTextBuilder {
  ...
  void add_useSystemFont(bool useSystemFont) {
    fbb_.AddElement<uint8_t>(RichText::VT_USESYSTEMFONT, static_cast<uint8_t>(useSystemFont), 0);
  }
...
inline flatbuffers::Offset<RichText> CreateRichText(
  ...
  builder_.add_node(node);
  builder_.add_useSystemFont(useSystemFont);
  builder_.add_horizontalAlignment(horizontalAlignment);
  return builder_.Finish();
}
...
struct AnimationRef FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *clips() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>> *>(VT_CLIPS);
  }
...
struct AnimationRefBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_clips(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::String>>> clips) {
...
inline flatbuffers::Offset<AnimationRef> CreateAnimationRefDirect(
  ...
  return creator::buffers::CreateAnimationRef(
      _fbb,
      clips ? _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>>(*clips) : 0,
      playOnLoad,
